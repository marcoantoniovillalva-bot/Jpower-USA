  ...
  return (
    <div className="relative">
      ...
      <div className="fixed bottom-0 left-0 w-full z-40 pointer-events-none">
        <div className="container mx-auto px-6 pb-8 flex justify-center">
          <motion.div 
            initial={{ y: 100 }}
            animate={{ y: 0 }}
            className="bg-white/90 backdrop-blur-md border border-dark/10 px-8 py-4 rounded-full shadow-2xl pointer-events-auto flex items-center gap-6"
          >
            <div className="hidden sm:block">
              <div className="text-xs font-bold text-dark/40 uppercase tracking-widest">Emergency 24/7</div>
              <div className="text-lg font-bold text-dark">{CONTACT_INFO.phone}</div>
            </div>
            <a href={`tel:${CONTACT_INFO.phone}`} className="btn-primary py-3 px-8 flex items-center gap-2">
              <Phone size={18} />
              {content.hero.cta}
            </a>
          </motion.div>
